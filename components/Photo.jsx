  ...
  <div className="relative w-full h-full">
    <motion.div initial={{opacity:0}} animate={{opacity:1, transition:{delay:2, duration:0.4, ease:"easeInOut"},
        ...
        className="w-[298px] h-[298px] xl:w-[498px] xl:h-[498px] mix-blend-lighten absolute">
            <Image src="/assets/photo1.png" priority fill alt="photo" className="object-contain"/>
        </motion.div>
    <motion.svg className="w-[300px] xl:w-[500px] h-[300px] xl:h-[500px]" fill="transparent" viewBox="0 0 506 506" xmlns="http://www.w3.org/2000/svg">
